        ...
        <div className="mx-auto max-w-5xl px-6 py-24 sm:py-32">
            <ol className="relative border-l border-gray-200 dark:border-gray-700">                  
                <li className="mb-10 ml-4">
                    ...
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white">V0.0.0 public release</h3>
                    <p className="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">Published the first working version of the web-app. Making Stein Programs&apos;produced news available to anyone.</p>
