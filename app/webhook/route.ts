...
import { cancelDatabaseSubscription, updateDatabaseSubscription as updateDatabaseSubscription } from "@/components/server/database";
...
async function handleStripeWebhook(body: any) {
    ...
    switch (type) {
        ...
        case "checkout.session.completed":
            ...
            await updateDatabaseSubscription(userId, subscriptionId, tier);
        ...
        case "customer.subscription.updated":
            ...
            updateDatabaseSubscription(meta.userId, subId, meta.tier);
            return new Response(
