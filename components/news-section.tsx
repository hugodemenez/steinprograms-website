...
export default async function NewsSection(){
  ...
  var data : { content: string | null; created_at: string; id: string; label: "BTC" | "ETH" | "XRP" | null; score: number | null; title: string | null; }[] | null 
  ...
  return (
    <div className="py-4 sm:py-8 px-6">
      ...
      <div className=" mx-auto mt-10 grid grid-cols-1 gap-x-8 gap-y-16 border-t border-gray-200 pt-10 sm:mt-16 sm:pt-16 lg:mx-0 lg:max-w-none lg:grid-cols-3 relative">
          ...
          {!user.user?
            <p className='dark:text-white'>You can access premium news if you sign in!</p>
            :
            ""
          }
      </div>
