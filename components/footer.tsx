...
export default function Footer(){
    return (
        <footer className="flex z-40 max-w-5xl mx-auto h-auto items-center justify-center px-6 pb-2">
            <div className="w-full mx-auto max-w-screen-xl p-4 md:flex md:items-center md:justify-between bg-white rounded-none shadow dark:bg-black dark:border dark:border-gray-600">
